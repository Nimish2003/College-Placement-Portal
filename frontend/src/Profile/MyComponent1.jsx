...
function MyComponent1() {
  ...
  const renderInputFields = () => {
    switch (yearOfStudy) {
      ...
      case "4th year":
        ...
        <div className="w-full mb-4">
          <label htmlFor="6thSemGPA" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
            6th Semester GPA
          </label>
          <input
            type="text"
          ...
          />
          <label htmlFor="6thSemPercentage" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
            Percentage
          </label>
          <input
            type="text"
  ...
  return (
    <div className="col-span-2 grid">
      <div className="w-full mb-4">
        <label htmlFor="year" className="block text-sm font-medium leading-none">
          Year of Study
        </label>
        <select
          id="year"
      ...
      <div> 
        <p className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 mb-4"> Enter your semester GPA</p>
      </div>
