  ...
  return (
    <div className="col-span-2 grid">
      <div className="w-full">
        ...
        <select
          id="branch"
          className="flex h-10 mt-1 block w-full px-3 py-2 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-black/30 focus:border-black/30"
          value={branch}
